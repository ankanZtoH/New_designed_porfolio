        ...
        <section id="contact" className="py-24 relative overflow-hidden bg-dark text-md">
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-8 md:mb-16">
                    <h2 className="text-2xl md:text-5xl font-bold font-heading text-white mb-3 md:mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-12 max-w-6xl mx-auto">
                    ...
                    {/* Functional Form */}
                    <form onSubmit={handleSubmit} className="bg-surface/20 backdrop-blur-md p-5 md:p-8 rounded-3xl border border-white/5 flex flex-col gap-3 md:gap-4 shadow-xl">
                        <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">Send a Message</h3>

                        <div className="grid md:grid-cols-2 gap-3 md:gap-4">
                            <div className="space-y-1.5 md:space-y-2">
                                <label className="text-[10px] md:text-xs text-gray-400 font-medium ml-1">Your Name</label>
                                <input
                                    type="text"
                                    name="name"
                                    value={formData.name}
